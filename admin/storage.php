                                        ...
                                        <tr class="table-row">
                                            ...
                                            <td class="py-3 px-3 text-center">
                                                <div class="flex gap-2 justify-center">
                                                    <button type="button" onclick="viewFile('<?php echo htmlspecialchars($file['file_name']); ?>', '<?php echo htmlspecialchars(addslashes($file['title']), ENT_QUOTES); ?>')" class="btn-icon btn-icon-green" title="Preview">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <a href="../uploads/storage/<?php echo htmlspecialchars($file['file_name']); ?>" download class="btn-icon btn-icon-blue" title="Download">
                                                        <i class="fas fa-download"></i>
                                                    </a>
                                                    <button type="button" onclick="deleteFile(<?php echo $file['id']; ?>, '<?php echo htmlspecialchars(addslashes($file['title']), ENT_QUOTES); ?>')" class="btn-icon btn-icon-red" title="Delete">
            ...
            <form method="POST" enctype="multipart/form-data" id="uploadForm">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control" placeholder="e.g., Annual Financial Report 2023" required>
                    </div>
...
endforeach; ?>
                    ...
                    <div id="customCategoryDiv" class="form-group" style="display: none;">
                        <label class="form-label" for="custom_category">Specify Custom Category *</label>
                        <input type="text" id="custom_category" name="custom_category" class="form-control" placeholder="Enter category name">
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label" for="storage_file">Choose File *</label>
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-colors">
                            <div class="space-y-1 text-center">
                                <i class="fas fa-file-upload text-3xl text-gray-400 mb-3 block"></i>
                                <div class="flex text-sm text-gray-600">
                                    <label for="storage_file" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                        <span>Upload a file</span>
                                        <input id="storage_file" name="storage_file" type="file" class="sr-only" required>
                                    </label>
                                    <p class="pl-1">or drag and drop</p>
                                </div>
                                <p class="text-xs text-gray-400">PDF, DOC, XLS, PNG, JPG up to 10MB</p>
                            </div>
                        </div>
                        <p id="file-name-display" class="text-xs text-blue-600 mt-2 font-medium"></p>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" name="upload_file" class="btn-primary">
                        <i class="fas fa-check mr-2"></i>Start Upload
                    </button>
                </div>
            </form>
        </div>
    ...
    <div id="fileModal" class="modal-overlay" onclick="closeFileModal(event)">
        <div class="modal-content modal-xl" onclick="event.stopPropagation()">
            <div class="modal-header">
                ...
                <button onclick="closeFileModal()" class="text-gray-400 hover:text-gray-600 transition">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div class="modal-body p-0">
                <div id="fileViewerContainer" class="bg-gray-100 min-h-[500px] flex items-center justify-center">
                    <iframe id="fileViewer" class="w-full h-[70vh] border-none" src=""></iframe>
                </div>
                <div id="fileNotFound" style="display: none;" class="text-center py-20 px-6">
                    <i class="fas fa-exclamation-triangle text-5xl text-amber-400 mb-4"></i>
                    <p class="text-gray-800 text-xl font-bold">Preview Unavailable</p>
                    <p class="text-gray-500 mt-2">This file format cannot be previewed in the browser or the file is missing.</p>
                </div>
            </div>
            <div class="modal-footer">
                <a href="#" id="downloadFileLink" download class="btn-primary bg-blue-500 hover:bg-blue-600">
                    <i class="fas fa-download mr-2"></i>Download File
                </a>
                <button type="button" onclick="closeFileModal()" class="btn-secondary">
